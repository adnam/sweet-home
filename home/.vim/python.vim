...
map  <A-S-c>   :call PythonSelectObject("class")<CR>
map  <A-S-f>   :call PythonSelectObject("function")<CR>
map  <A-f>     :call PythonDec("function", 1)<CR>
map  <A-C-f>   :call PythonDec("function", -1)<CR>
map  <A-c>     :call PythonDec("class", 1)<CR>
map  <A-C-c>   :call PythonDec("class", -1)<CR>
