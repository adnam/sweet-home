...
hi Statement	  term=bold  cterm=bold ctermfg=yellow	guifg=#000000 gui=bold
hi PreProc		  term=underline  ctermfg=darkblue	guifg=#505080 gui=bold
hi Type			  term=underline  cterm=bold ctermfg=lightgreen  gui=bold  guifg=#000000
