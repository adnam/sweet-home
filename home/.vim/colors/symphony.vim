...
" Version:      0.1
" 
" Symphony colorscheme, based on the Symphony code examples.
...
hi Comment		  term=bold  cterm=bold ctermfg=cyan  guifg=#BD48B3
hi Constant		  term=underline  cterm=bold ctermfg=magenta  guifg=#99FF00
hi Special		  term=bold  cterm=bold ctermfg=red  guifg=#FFFFFF gui=bold
hi Identifier	  term=underline   ctermfg=brown  guifg=white
hi Function		  guifg=#07DFFC
